(() => {
    ...
    class MousePRLX {
        ...
        paralaxMouseInit(paralaxMouse) {
            paralaxMouse.forEach((el => {
                ...
                const paramСoefficientX = el.dataset.prlxCx ? +el.dataset.prlxCx : 170;
                const paramСoefficientY = el.dataset.prlxCy ? +el.dataset.prlxCy : 170;
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swipr")) new core(".swipr", {
